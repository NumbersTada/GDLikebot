print("GDLikebot - Level Like/Dislike Bot")
...
args=sys.argv
if len(args) != 3:
    print("Usage: "+__file__.split(os.getcwd()+"\\")[1]+" <LEVELID> <TYPE>\nType: 1 for like, 0 for dislike")
    exit()
...
def bot(proxy):
    ...
    data = {
        ...
        "special": "0",
        "rs": grs,
        "chk": chk(["0",levelid,liketype,"1",grs,gjaccid[rand],gudid,guuid],"58281","ysg6pUrtjn0J")
    }
    try:
